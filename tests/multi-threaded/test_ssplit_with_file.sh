...
${BRT_MARIAN}/bergamot-test --bergamot-mode test-response-source-sentences ${BRT_FILE_ARGS} < ${BRT_DATA}/ssplit/sample.en > $OUTFILE 
...
EXPECTED=$BRT_DATA/ssplit/sample.en.expected
${BRT_MARIAN}/bergamot-test --bergamot-mode test-response-source-sentences ${BRT_BYTEARRAY_ARGS} < ${BRT_DATA}/ssplit/sample.en > $OUTFILE 
