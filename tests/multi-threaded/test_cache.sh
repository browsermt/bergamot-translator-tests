...
${BRT_MARIAN}/bergamot-test --bergamot-mode test-translation-cache --cache-translations=1 --cache-collect-stats=1 ${BRT_FILE_ARGS} < ${BRT_DATA}/simple/bergamot/input.txt
