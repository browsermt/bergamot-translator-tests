...
${BRT_MARIAN}/tests/async --bergamot-mode test-translation-cache --cache-translations=1 --cache-collect-stats=1 ${BRT_ASYNC_ARGS} < ${BRT_DATA}/simple/bergamot/input.txt
