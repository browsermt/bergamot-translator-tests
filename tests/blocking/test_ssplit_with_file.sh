...
${BRT_MARIAN}/tests/blocking --bergamot-mode test-response-source-sentences ${BRT_WASM_ARGS} < ${BRT_DATA}/ssplit/sample.en > $OUTFILE 
...
EXPECTED=$BRT_DATA/ssplit/sample.en.expected
${BRT_MARIAN}/tests/blocking --bergamot-mode test-response-source-sentences ${BRT_WASM_ARGS} --bytearray < ${BRT_DATA}/ssplit/sample.en > $OUTFILE 
